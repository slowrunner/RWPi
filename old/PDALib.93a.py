...
# 14Jun2016  added servopin[pin] to the setMode(pin,ECHO) (was fixed at 22)
#            Added readDistance2sg(Servo0..7,GPIOdirect) 
#                     to allow TRIG direct connect to PiB+|2|3B extended GPIO
#                     Suggest TRIG direct to GPIO26 (connector pin 37)
...
def pinMode(pin,newmode):
  ...
  if pin < 8: # only accept valid modes
    ...
    if newmode == ECHO:
       mode[pin] = newmode
       # Alan - echo can be on any servo pin
       # my_echo1 = pi.callback(22, pigpio.RISING_EDGE,  _echo1)
       # my_echo0 = pi.callback(22, pigpio.FALLING_EDGE, _echo0)
       my_echo1 = pi.callback(servopin[pin], pigpio.RISING_EDGE,  _echo1)
       my_echo0 = pi.callback(servopin[pin], pigpio.FALLING_EDGE, _echo0)
    return 0
